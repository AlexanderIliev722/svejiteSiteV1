  ...
  return (
    <footer className="bg-gray-900 text-gray-500 py-12 border-t border-gray-800">
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        {/* Copyright */}
        <p className="text-sm">
          &copy; {currentYear} Свежите. Всички права запазени.
        </p>

        {/* Social Links */}
        <div className="flex gap-4">
          <a href="#" className="w-10 h-10 rounded bg-gray-800 flex items-center justify-center hover:bg-sky-600 hover:text-white transition-colors" aria-label="Facebook">
          ...
          <a href="#" className="w-10 h-10 rounded bg-gray-800 flex items-center justify-center hover:bg-orange-500 hover:text-white transition-colors" aria-label="Instagram">
